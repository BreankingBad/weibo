...
import com.round.imageview.CircularImage;
...
public class LeftMenuFragment extends AbstractAppFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        layout.nickname.setOnClickListener(new OnClickListener() {
...
//    private boolean showSearchPage(boolean reset) {// to be used in change skin button,yangxj@20131015 
...
//                    drawButtonsBackground(5);
    ...
    private void drawButtonsBackground(int position) {
        ...
        //it really need to do so,though in style have these property,but cannt dissmiss background color,yangxj@20121018
...
//            round the protrait,yangxj@20131018
