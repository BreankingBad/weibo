...
public class CommentsToMeTimeLineFragment extends AbstractTimeLineFragment<CommentListBean> implements IRemoveItem {
    ...
    private void checkUnreadInfo() {
        ...
        Log.e("yangxj",getActivity().toString());
...
//        CommentsTimeLine parent = (CommentsTimeLine) getParentFragment();//yangxj@20140228,combine comment to mention
        MentionsTimeLine parent = new MentionsTimeLine() ;
