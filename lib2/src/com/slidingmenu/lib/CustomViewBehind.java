...
public class CustomViewBehind extends ViewGroup {
    ...
    private static final int MARGIN_THRESHOLD = 50; // dips閿涘畮dd left touch margin,yangxj@20131015
    ...
    public void drawFade(View content, Canvas canvas, float openPercent) {
        ...
        mFadePaint.setColor(Color.argb(alpha,0, 206, 255));//change fade out color,yangxj@20131030
        int left = 0;
        int right = 0;
        if (mMode == SlidingMenu.LEFT) {
